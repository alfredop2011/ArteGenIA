    ...
    <div style={{ background: "var(--home-bg)", color: "var(--home-text)" }}>
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 pt-3 sm:pt-4 pb-4">
        ...
        {/* ═════ HERO = CARRUSEL 3D DE FLYERS REALES ═════
            Ya no hay hero de texto arriba: el carrusel 3D con su rotulo grande
            ("PLANTILLAS DE FLYER / tu evento / PARA TU EVENTO") ES el hero.
            Rompe el ancho del contenedor a proposito porque es sticky a
            pantalla completa: w-screen + left-1/2 -translate-x-1/2 lo saca del
            max-w-6xl centrado (con margenes negativos solo se recuperaba el
            padding, no el ancho maximo). -mt recorta el padding-top del
            contenedor para que la escena arranque pegada al header. */}
        <div className="relative left-1/2 -translate-x-1/2 w-screen max-w-[100vw] -mt-3 sm:-mt-4 mb-6">
