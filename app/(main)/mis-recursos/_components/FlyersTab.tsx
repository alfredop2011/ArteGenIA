...
/**
 * FlyersTab — contenido del tab "Flyers" dentro de /mis-recursos.
 *
 * Es el legacy de /projects/page.tsx extraído como componente. Lógica
 * intacta (load/delete/duplicate). El wrapper de auth gate vive en
 * page.tsx, así que aquí asumimos user logueado.
 */

import { useEffect, useState } from "react";
import Link from "next/link";
import { useRouter } from "next/navigation";
import { Palette, Pencil, Trash2, Plus, Copy } from "lucide-react";
