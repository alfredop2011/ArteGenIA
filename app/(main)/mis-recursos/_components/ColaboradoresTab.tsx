...
/**
 * ColaboradoresTab — contenido del tab "Colaboradores" dentro de /mis-recursos.
 *
 * Legacy de /colaboradores/page.tsx extraído como componente (Z.15.1). Lógica
 * intacta (fetch, filtros, modales). El wrapper outer (max-w, padding) vive
 * en page.tsx, así que aquí solo va el contenido interno.
 */
...
export default function ColaboradoresTab() {
  ...
  return (
    <div>
      {/* Header — el h1 "Mis Recursos" vive en el padre. Aquí solo subtitle + CTA */}
