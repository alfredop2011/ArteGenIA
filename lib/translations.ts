...
const es: Dict = {
  ...
  "home.hero.title.rotating": "tu fiesta, tus conciertos, tu festival, tus clases de baile, tu discoteca, tu evento corporativo",
...
const en: Dict = {
  ...
  "home.hero.title.rotating": "your party, your concerts, your festival, your dance classes, your club, your corporate event",
...
const fr: Dict = {
  ...
  "home.hero.title.rotating": "votre fête, vos concerts, votre festival, vos cours de danse, votre discothèque, votre événement d'entreprise",
...
const pt: Dict = {
  ...
  "home.hero.title.rotating": "a tua festa, os teus concertos, o teu festival, as tuas aulas de dança, a tua discoteca, o teu evento corporativo",
