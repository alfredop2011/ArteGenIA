...
const es: Dict = {
  ...
  // /templates v2
  "templates.greeting": "Hola {name}, elige tu plantilla",
  "templates.greetingFallback": "Elige tu plantilla",
  "templates.tagline": "Plantillas profesionales de flyers para eventos, DJs y fiestas. Publica esta noche.",
  ...
  "mobileEditor.assistant.headerTitle": "Dime los datos y te los coloco en el flyer",
  "mobileEditor.assistant.headerDesc": "Escribe qué evento es (fecha, lugar, precio…) y la IA reparte cada dato. Campos a rellenar:",
...
const en: Dict = {
  ...
  // /templates v2
  "templates.greeting": "Hi {name}, pick your template",
  "templates.greetingFallback": "Pick your template",
  "templates.tagline": "Pro flyer templates for events, DJs and parties. Publish tonight.",
  ...
  "mobileEditor.assistant.headerTitle": "Tell me the details and I'll place them in the flyer",
  "mobileEditor.assistant.headerDesc": "Write what the event is (date, place, price…) and the AI arranges each detail. Fields to fill:",
...
const fr: Dict = {
  ...
  "mobileEditor.assistant.headerTitle": "Dites-moi les infos et je les place dans le flyer",
  "mobileEditor.assistant.headerDesc": "Écrivez de quel événement il s'agit (date, lieu, prix…) et l'IA place chaque info. Champs à remplir :",
...
const pt: Dict = {
  ...
  "mobileEditor.assistant.headerTitle": "Diz-me os dados e eu coloco-os no flyer",
  "mobileEditor.assistant.headerDesc": "Escreve qual é o evento (data, local, preço…) e a IA distribui cada dado. Campos a preencher:",
