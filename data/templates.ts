...
export const templates: Template[] = [
    // 1 — Noche Magnética (Fiesta / Club)
    {
        ...
        layers: [
            ...
            { id: "artist-photo", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/Filosofin-.png", x: 0, y: -120, scaleX: 0.478, scaleY: 0.478, opacity: 1 },
    ...
    // 2 — Urban Party (Concierto)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "URBAN PARTY", x: 35, y: 155, width: 360, fontSize: 40, fontFamily: "Arial", color: "#facc15", fontWeight: "bold", textAlign: "center" },
            ...
            { id: "price", type: "text", text: "ENTRADA ANTICIPADA 25€", x: 55, y: 460, width: 320, fontSize: 16, fontFamily: "Arial", color: "#111111", fontWeight: "bold", textAlign: "center" },
        ],
    },
    ...
    // 3 — DJ Neon (Discoteca)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "DJ NEON", x: 35, y: 150, width: 360, fontSize: 56, fontFamily: "Arial", color: "#22d3ee", fontWeight: "bold", textAlign: "center" },
    ...
    // 4 — Evento Premium (Gala)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "EVENTO PREMIUM", x: 35, y: 165, width: 360, fontSize: 38, fontFamily: "Arial", color: "#facc15", fontWeight: "bold", textAlign: "center" },
    ...
    // 5 — Salsa Caliente (Salsa / Bachata)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "SALSA CALIENTE", x: 35, y: 135, width: 360, fontSize: 44, fontFamily: "Arial", color: "#fef2f2", fontWeight: "bold", textAlign: "center" },
    ...
    // 6 — Festival Aurora (Festival)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "FESTIVAL", x: 35, y: 120, width: 360, fontSize: 52, fontFamily: "Arial", color: "#ffffff", fontWeight: "bold", textAlign: "center" },
            { id: "title2", type: "text", text: "AURORA", x: 35, y: 178, width: 360, fontSize: 52, fontFamily: "Arial", color: "#34d399", fontWeight: "bold", textAlign: "center" },
    ...
    // 7 — Bachata Nights (Bachata)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "BACHATA", x: 35, y: 130, width: 360, fontSize: 58, fontFamily: "Arial", color: "#fce7f3", fontWeight: "bold", textAlign: "center" },
            { id: "title2", type: "text", text: "NIGHTS", x: 35, y: 193, width: 360, fontSize: 58, fontFamily: "Arial", color: "#ec4899", fontWeight: "bold", textAlign: "center" },
    ...
    // 8 — Vibra Fest (Festival Urbano)
    {
        ...
        layers: [
            ...
            { id: "title", type: "text", text: "VIBRA", x: 35, y: 115, width: 360, fontSize: 72, fontFamily: "Arial", color: "#a855f7", fontWeight: "bold", textAlign: "center" },
            { id: "title2", type: "text", text: "FEST 2025", x: 35, y: 190, width: 360, fontSize: 36, fontFamily: "Arial", color: "#06b6d4", fontWeight: "bold", textAlign: "center" },
