...
// ─── 71 — Intensivo Timba Fin de Semana (4 artistas 2 arriba 2 abajo)
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "spot-1", type: "shape", shape: "circle", x: 260, y: 320, width: 440, height: 440, fill: "rgba(249,115,22,0.30)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "spot-2", type: "shape", shape: "circle", x: 820, y: 320, width: 440, height: 440, fill: "rgba(249,115,22,0.30)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "spot-3", type: "shape", shape: "circle", x: 260, y: 620, width: 380, height: 380, fill: "rgba(34,197,94,0.32)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "spot-4", type: "shape", shape: "circle", x: 820, y: 620, width: 380, height: 380, fill: "rgba(34,197,94,0.32)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/07_lucia_mateo_pareja.png", x: 260, y: 165, scaleX: 0.62, scaleY: 0.62, originX: "center", originY: "top", shadow: { color: "rgba(249,115,22,0.85)", blur: 40, offsetX: 0, offsetY: 0 } },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/05_valentina_damian_pareja.png", x: 820, y: 165, scaleX: 0.62, scaleY: 0.62, originX: "center", originY: "top", shadow: { color: "rgba(249,115,22,0.85)", blur: 40, offsetX: 0, offsetY: 0 } },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 260, y: 505, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top", shadow: { color: "rgba(34,197,94,0.85)", blur: 35, offsetX: 0, offsetY: 0 } },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 820, y: 505, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top", shadow: { color: "rgba(34,197,94,0.85)", blur: 35, offsetX: 0, offsetY: 0 } },
                { id: "stage-fade-1", type: "shape", shape: "rect", x: 0, y: 780, width: 1080, height: 50, fill: "rgba(2,20,10,0.35)", selectable: false },
                { id: "stage-fade-2", type: "shape", shape: "rect", x: 0, y: 830, width: 1080, height: 50, fill: "rgba(2,20,10,0.60)", selectable: false },
...
// ─── 80 — Intensivo Reggaeton 4 profesores (grid dorado/negro) ──────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "grid-1-halo", type: "shape", shape: "circle", x: 270, y: 390, width: 300, height: 300, fill: "rgba(217,165,89,0.28)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 270, y: 265, scaleX: 0.28, scaleY: 0.28, originX: "center", originY: "top" },
                { id: "art-1-name", type: "text", text: "ALEX R.", x: 100, y: 545, width: 400, fontSize: 30, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 100, fontStyle: "italic" },
                { id: "art-1-role", type: "text", text: "URBAN CHOREO", x: 100, y: 585, width: 400, fontSize: 10, fontFamily: "Montserrat, sans-serif", color: "rgba(217,165,89,0.75)", fontWeight: "600", textAlign: "center", originX: "left", originY: "top", charSpacing: 450 },
                { id: "grid-2-halo", type: "shape", shape: "circle", x: 810, y: 390, width: 300, height: 300, fill: "rgba(217,165,89,0.28)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 810, y: 265, scaleX: 0.28, scaleY: 0.28, originX: "center", originY: "top" },
                { id: "art-2-name", type: "text", text: "SOFÍA M.", x: 580, y: 545, width: 400, fontSize: 30, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 100, fontStyle: "italic" },
                { id: "art-2-role", type: "text", text: "PERREO INTENSO", x: 580, y: 585, width: 400, fontSize: 10, fontFamily: "Montserrat, sans-serif", color: "rgba(217,165,89,0.75)", fontWeight: "600", textAlign: "center", originX: "left", originY: "top", charSpacing: 450 },
                { id: "grid-3-halo", type: "shape", shape: "circle", x: 270, y: 720, width: 280, height: 280, fill: "rgba(217,165,89,0.28)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 270, y: 610, scaleX: 0.25, scaleY: 0.25, originX: "center", originY: "top" },
                { id: "art-3-name", type: "text", text: "MARCO L.", x: 100, y: 860, width: 400, fontSize: 28, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 100, fontStyle: "italic" },
                { id: "art-3-role", type: "text", text: "OLD SCHOOL", x: 100, y: 895, width: 400, fontSize: 10, fontFamily: "Montserrat, sans-serif", color: "rgba(217,165,89,0.75)", fontWeight: "600", textAlign: "center", originX: "left", originY: "top", charSpacing: 450 },
                { id: "grid-4-halo", type: "shape", shape: "circle", x: 810, y: 720, width: 280, height: 280, fill: "rgba(217,165,89,0.28)", opacity: 0.9, originX: "center", originY: "center", selectable: false },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 810, y: 610, scaleX: 0.23, scaleY: 0.23, originX: "center", originY: "top" },
                { id: "art-4-name", type: "text", text: "LAURA S.", x: 580, y: 860, width: 400, fontSize: 28, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 100, fontStyle: "italic" },
                { id: "art-4-role", type: "text", text: "STREET DANCE", x: 580, y: 895, width: 400, fontSize: 10, fontFamily: "Montserrat, sans-serif", color: "rgba(217,165,89,0.75)", fontWeight: "600", textAlign: "center", originX: "left", originY: "top", charSpacing: 450 },
