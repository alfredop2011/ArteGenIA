...
// ─── 69 — Cuba Fest Line-up 5 artistas (diamante) ───────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "star-l", type: "text", text: "★", x: 50, y: 470, width: 60, fontSize: 45, fontFamily: "Playfair Display, serif", color: "#ffffff", opacity: 0.8, textAlign: "left" },
                { id: "star-r", type: "text", text: "★", x: 970, y: 470, width: 60, fontSize: 45, fontFamily: "Playfair Display, serif", color: "#ffffff", opacity: 0.8, textAlign: "left" },
