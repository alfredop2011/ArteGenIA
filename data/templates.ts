...
// ─── 62 — Masterclass Kizomba Fusion con Nelo Paim (1 solo) ─────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 540, y: 40, scaleX: 1.65, scaleY: 1.65, originX: "center", originY: "top", shadow: { color: "rgba(212,160,80,0.5)", blur: 60, offsetX: 0, offsetY: 0 } },
                ...
                { id: "title", type: "text", text: "NELO PAIM", x: 0, y: 950, width: 1080, fontSize: 110, fontFamily: "Playfair Display, serif", color: "#ffffff", textAlign: "center", charSpacing: 30 },
...
// ─── 63 — Kizomba Weekend en pareja (2 artistas) ─────────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/05_valentina_damian_pareja.png", x: 540, y: 120, scaleX: 1.55, scaleY: 1.55, originX: "center", originY: "top", shadow: { color: "rgba(217,165,89,0.55)", blur: 55, offsetX: 0, offsetY: 0 } },
                { id: "vignette", type: "shape", shape: "rect", x: 0, y: 860, width: 1080, height: 490, fill: "rgba(4,10,20,0.85)", selectable: false },
                { id: "title-1", type: "text", text: "KAYSHA", x: 0, y: 905, width: 1080, fontSize: 90, fontFamily: "Playfair Display, serif", color: "#ffffff", textAlign: "center", charSpacing: 50 },
                ...
                { id: "title-2", type: "text", text: "SANDRA", x: 0, y: 1030, width: 1080, fontSize: 90, fontFamily: "Playfair Display, serif", color: "#ffffff", textAlign: "center", charSpacing: 50 },
...
// ─── 65 — Kizomba 4 estilos (4 artistas grid 2x2) ───────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "card-1-bg", type: "shape", shape: "rect", x: 80, y: 320, width: 440, height: 260, fill: "#f4b6c0", radius: 20, selectable: false },
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 300, y: 335, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "card-1-tag", type: "text", text: "URBAN KIZ", x: 100, y: 545, width: 400, fontSize: 22, fontFamily: "Poppins, sans-serif", color: "#1a0a12", fontWeight: "800", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "card-2-bg", type: "shape", shape: "rect", x: 560, y: 320, width: 440, height: 260, fill: "rgba(244,182,192,0.15)", radius: 20, stroke: "#f4b6c0", strokeWidth: 2, selectable: false },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 780, y: 335, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "card-2-tag", type: "text", text: "TARRAXO", x: 580, y: 545, width: 400, fontSize: 22, fontFamily: "Poppins, sans-serif", color: "#f4b6c0", fontWeight: "800", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "card-3-bg", type: "shape", shape: "rect", x: 80, y: 610, width: 440, height: 260, fill: "rgba(244,182,192,0.15)", radius: 20, stroke: "#f4b6c0", strokeWidth: 2, selectable: false },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 300, y: 625, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "card-3-tag", type: "text", text: "SEMBA", x: 100, y: 835, width: 400, fontSize: 22, fontFamily: "Poppins, sans-serif", color: "#f4b6c0", fontWeight: "800", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "card-4-bg", type: "shape", shape: "rect", x: 560, y: 610, width: 440, height: 260, fill: "#f4b6c0", radius: 20, selectable: false },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 780, y: 625, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "card-4-tag", type: "text", text: "GHETTO", x: 580, y: 835, width: 400, fontSize: 22, fontFamily: "Poppins, sans-serif", color: "#1a0a12", fontWeight: "800", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "info-band", type: "shape", shape: "rect", x: 0, y: 920, width: 1080, height: 430, fill: "rgba(15,5,12,0.9)", selectable: false },
...
// ─── 66 — Festival Kizomba 6 artistas (coral estilo #15) ────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artists-list", type: "text", text: "NELO PAIM · KAYSHA · NERU AFRICA · MÁRCIO · YURI · SANDRA", x: 0, y: 1010, width: 1080, fontSize: 17, fontFamily: "Montserrat, sans-serif", color: "#f472b6", fontWeight: "600", textAlign: "center", charSpacing: 150 },
...
// ─── 67 — Masterclass Timba Cubana con Yulien Oviedo (1 solo) ───────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "title", type: "text", text: "YULIEN\nOVIEDO", x: 0, y: 970, width: 1080, fontSize: 92, fontFamily: "Anton, Impact, sans-serif", color: "#ffffff", textAlign: "center", charSpacing: 40, lineHeight: 0.9 },
...
// ─── 68 — Timba Session en pareja (2 artistas) ──────────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/06_isabela_alejandro_pareja.png", x: 540, y: 100, scaleX: 1.5, scaleY: 1.5, originX: "center", originY: "top", shadow: { color: "rgba(127,29,29,0.5)", blur: 40, offsetX: 0, offsetY: 0 } },
                ...
                { id: "title", type: "text", text: "ALEXANDER", x: 0, y: 890, width: 1080, fontSize: 76, fontFamily: "Anton, Impact, sans-serif", color: "#fbbf24", textAlign: "center", charSpacing: 30 },
                ...
                { id: "title-2", type: "text", text: "YAILENE", x: 0, y: 1000, width: 1080, fontSize: 76, fontFamily: "Anton, Impact, sans-serif", color: "#ffffff", textAlign: "center", charSpacing: 30 },
...
// ─── 69 — Cuba Fest Line-up 5 artistas (diamante) ───────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 200, y: 170, scaleX: 0.45, scaleY: 0.45, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,0.9)", blur: 30, offsetX: 0, offsetY: 0 } },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 880, y: 170, scaleX: 0.45, scaleY: 0.45, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,0.9)", blur: 30, offsetX: 0, offsetY: 0 } },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/06_isabela_alejandro_pareja.png", x: 210, y: 500, scaleX: 0.4, scaleY: 0.4, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,0.9)", blur: 30, offsetX: 0, offsetY: 0 } },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/07_lucia_mateo_pareja.png", x: 870, y: 500, scaleX: 0.4, scaleY: 0.4, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,0.9)", blur: 30, offsetX: 0, offsetY: 0 } },
                { id: "art-5", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 540, y: 260, scaleX: 0.7, scaleY: 0.7, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,1)", blur: 50, offsetX: 0, offsetY: 0 } },
                ...
                { id: "artists", type: "text", text: "YULIEN OVIEDO · ALEXANDER ABREU · CHARANGA HABANERA · ELITO REVÉ · VAN VAN", x: 0, y: 1065, width: 1080, fontSize: 14, fontFamily: "Montserrat, sans-serif", color: "#fbbf24", fontWeight: "700", textAlign: "center", charSpacing: 150 },
...
// ─── 70 — Semana Timba 3 profesores (fila con 1 grande) ─────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-big", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 300, y: 190, scaleX: 1.05, scaleY: 1.05, originX: "center", originY: "top", shadow: { color: "rgba(251,113,133,0.9)", blur: 55, offsetX: 0, offsetY: 0 } },
                { id: "art-s1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 780, y: 260, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top", shadow: { color: "rgba(20,184,166,0.9)", blur: 35, offsetX: 0, offsetY: 0 } },
                { id: "art-s2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 780, y: 550, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top", shadow: { color: "rgba(251,113,133,0.9)", blur: 35, offsetX: 0, offsetY: 0 } },
                ...
                { id: "artists", type: "text", text: "YAILENE CARBÓ  ·  ELIER MUÑOZ  ·  DAYÁN ABAD", x: 0, y: 1120, width: 1080, fontSize: 17, fontFamily: "Montserrat, sans-serif", color: "#5eead4", fontWeight: "600", textAlign: "center", charSpacing: 250 },
...
// ─── 71 — Intensivo Timba Fin de Semana (4 artistas 2 arriba 2 abajo)
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/07_lucia_mateo_pareja.png", x: 260, y: 140, scaleX: 0.75, scaleY: 0.75, originX: "center", originY: "top", shadow: { color: "rgba(249,115,22,0.85)", blur: 40, offsetX: 0, offsetY: 0 } },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/05_valentina_damian_pareja.png", x: 820, y: 140, scaleX: 0.75, scaleY: 0.75, originX: "center", originY: "top", shadow: { color: "rgba(249,115,22,0.85)", blur: 40, offsetX: 0, offsetY: 0 } },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 260, y: 490, scaleX: 0.6, scaleY: 0.6, originX: "center", originY: "top", shadow: { color: "rgba(34,197,94,0.85)", blur: 35, offsetX: 0, offsetY: 0 } },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 820, y: 490, scaleX: 0.6, scaleY: 0.6, originX: "center", originY: "top", shadow: { color: "rgba(34,197,94,0.85)", blur: 35, offsetX: 0, offsetY: 0 } },
                { id: "vignette", type: "shape", shape: "rect", x: 0, y: 880, width: 1080, height: 470, fill: "rgba(2,20,10,0.88)", selectable: false },
...
// ─── 72 — Masterclass Reparto con El Chulo (1 solo) ─────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 540, y: 60, scaleX: 1.7, scaleY: 1.7, originX: "center", originY: "top", shadow: { color: "rgba(250,204,21,0.95)", blur: 70, offsetX: 0, offsetY: 0 } },
                ...
                { id: "title", type: "text", text: "EL CHULO", x: 0, y: 890, width: 1080, fontSize: 128, fontFamily: "Anton, Impact, sans-serif", color: "#facc15", textAlign: "center", charSpacing: 40, stroke: "#ec4899", strokeWidth: 2 },
...
// ─── 73 — Reparto en pareja Bebeshito & Bombillo (2 artistas) ───────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/07_lucia_mateo_pareja.png", x: 540, y: 90, scaleX: 1.55, scaleY: 1.55, originX: "center", originY: "top", shadow: { color: "rgba(163,230,53,0.9)", blur: 60, offsetX: 0, offsetY: 0 } },
                ...
                { id: "title-1", type: "text", text: "BEBESHITO", x: 0, y: 935, width: 1080, fontSize: 92, fontFamily: "Anton, Impact, sans-serif", color: "#a3e635", textAlign: "center", charSpacing: 30, stroke: "#8b5cf6", strokeWidth: 1 },
                { id: "amp", type: "text", text: "×", x: 0, y: 1030, width: 1080, fontSize: 44, fontFamily: "Anton, Impact, sans-serif", color: "#ffffff", textAlign: "center" },
                { id: "title-2", type: "text", text: "BOMBILLO", x: 0, y: 1075, width: 1080, fontSize: 92, fontFamily: "Anton, Impact, sans-serif", color: "#8b5cf6", textAlign: "center", charSpacing: 30, stroke: "#a3e635", strokeWidth: 1 },
...
// ─── 74 — Reparto Weekend 4 profesores (grid) ───────────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "grid-1-bg", type: "shape", shape: "rect", x: 100, y: 310, width: 400, height: 260, fill: "rgba(236,72,153,0.2)", radius: 12, stroke: "#ec4899", strokeWidth: 2, selectable: false },
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 300, y: 320, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "art-1-name", type: "text", text: "YAKARTA", x: 100, y: 525, width: 400, fontSize: 22, fontFamily: "Anton, Impact, sans-serif", color: "#ec4899", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "grid-2-bg", type: "shape", shape: "rect", x: 540, y: 310, width: 400, height: 260, fill: "rgba(34,211,238,0.2)", radius: 12, stroke: "#22d3ee", strokeWidth: 2, selectable: false },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 740, y: 320, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "art-2-name", type: "text", text: "WOW POPY", x: 540, y: 525, width: 400, fontSize: 22, fontFamily: "Anton, Impact, sans-serif", color: "#22d3ee", textAlign: "center", originX: "left", originY: "top", charSpacing: 180 },
                { id: "grid-3-bg", type: "shape", shape: "rect", x: 100, y: 600, width: 400, height: 260, fill: "rgba(34,211,238,0.2)", radius: 12, stroke: "#22d3ee", strokeWidth: 2, selectable: false },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 300, y: 610, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "art-3-name", type: "text", text: "LA REINA", x: 100, y: 815, width: 400, fontSize: 22, fontFamily: "Anton, Impact, sans-serif", color: "#22d3ee", textAlign: "center", originX: "left", originY: "top", charSpacing: 200 },
                { id: "grid-4-bg", type: "shape", shape: "rect", x: 540, y: 600, width: 400, height: 260, fill: "rgba(236,72,153,0.2)", radius: 12, stroke: "#ec4899", strokeWidth: 2, selectable: false },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 740, y: 610, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top" },
                { id: "art-4-name", type: "text", text: "CHOCOLATE", x: 540, y: 815, width: 400, fontSize: 22, fontFamily: "Anton, Impact, sans-serif", color: "#ec4899", textAlign: "center", originX: "left", originY: "top", charSpacing: 150 },
                { id: "info-band", type: "shape", shape: "rect", x: 0, y: 900, width: 1080, height: 450, fill: "rgba(5,5,15,0.92)", selectable: false },
                { id: "date", type: "text", text: "SÁB 27 · DOM 28 DE JUNIO", x: 0, y: 940, width: 1080, fontSize: 30, fontFamily: "Anton, Impact, sans-serif", color: "#ffffff", textAlign: "center", charSpacing: 280 },
                { id: "hours", type: "text", text: "8 CLASES · 4 ESTILOS · 2 DÍAS", x: 0, y: 1000, width: 1080, fontSize: 18, fontFamily: "Anton, Impact, sans-serif", color: "#22d3ee", textAlign: "center", charSpacing: 300 },
                { id: "venue", type: "text", text: "REPUBLICA LATINA  ·  C/ TROCADERO 8  ·  SEVILLA", x: 0, y: 1075, width: 1080, fontSize: 17, fontFamily: "Montserrat, sans-serif", color: "#ec4899", fontWeight: "600", textAlign: "center", charSpacing: 200 },
                { id: "price", type: "text", text: "PACK 2 DÍAS  85€  ·  ANTICIPADA HASTA 20 JUN", x: 0, y: 1120, width: 1080, fontSize: 18, fontFamily: "Anton, Impact, sans-serif", color: "#ffffff", textAlign: "center", charSpacing: 200 },
                { id: "cta", type: "text", text: "REPARTOSEVILLA.COM  ·  20 PLAZAS", x: 0, y: 1190, width: 1080, fontSize: 14, fontFamily: "Montserrat, sans-serif", color: "rgba(34,211,238,0.85)", fontWeight: "700", textAlign: "center", charSpacing: 400 },
            ] },
        ],
    },
...
// ─── 75 — Reparto Bootcamp 3 profesores (escalonado) ────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 260, y: 200, scaleX: 0.9, scaleY: 0.9, originX: "center", originY: "top", shadow: { color: "rgba(255,20,147,0.9)", blur: 45, offsetX: 0, offsetY: 0 } },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 540, y: 260, scaleX: 0.9, scaleY: 0.9, originX: "center", originY: "top", shadow: { color: "rgba(217,70,239,0.9)", blur: 45, offsetX: 0, offsetY: 0 } },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 820, y: 200, scaleX: 0.9, scaleY: 0.9, originX: "center", originY: "top", shadow: { color: "rgba(255,20,147,0.9)", blur: 45, offsetX: 0, offsetY: 0 } },
                ...
                { id: "artists", type: "text", text: "EL CHULO · BEBESHITO · CHOCOLATE MC", x: 0, y: 1120, width: 1080, fontSize: 17, fontFamily: "Montserrat, sans-serif", color: "#f0abfc", fontWeight: "700", textAlign: "center", charSpacing: 300 },
...
// ─── 76 — Reparto Line-up 5 artistas cubanos (diamante) ─────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artists", type: "text", text: "EL CHULO · BEBESHITO · BOMBILLO · CHOCOLATE MC · YAKARTA", x: 0, y: 1015, width: 1080, fontSize: 15, fontFamily: "Montserrat, sans-serif", color: "#22c55e", fontWeight: "700", textAlign: "center", charSpacing: 150 },
...
// ─── 77 — Masterclass Reggaeton Old School (1 solo) ─────────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "artist", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 540, y: 80, scaleX: 1.75, scaleY: 1.75, originX: "center", originY: "top", shadow: { color: "rgba(244,63,94,0.95)", blur: 70, offsetX: 0, offsetY: 0 } },
...
// ─── 79 — Reggaeton Bootcamp 3 profesores (triangulo) ───────────────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-top", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 540, y: 100, scaleX: 1.0, scaleY: 1.0, originX: "center", originY: "top", shadow: { color: "rgba(236,72,153,0.9)", blur: 55, offsetX: 0, offsetY: 0 } },
                ...
                { id: "artists", type: "text", text: "RYAN CASTRO STYLE  ·  FEID STYLE  ·  BAD BUNNY STYLE", x: 0, y: 1075, width: 1080, fontSize: 15, fontFamily: "Montserrat, sans-serif", color: "#ec4899", fontWeight: "700", textAlign: "center", charSpacing: 250 },
...
// ─── 80 — Intensivo Reggaeton 4 profesores (grid dorado/negro) ──────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "grid-1-bg", type: "shape", shape: "rect", x: 100, y: 220, width: 400, height: 300, fill: "rgba(217,165,89,0.08)", radius: 8, stroke: "#d9a559", strokeWidth: 1, selectable: false },
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 300, y: 230, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "art-1-name", type: "text", text: "DEIVITH", x: 100, y: 475, width: 400, fontSize: 22, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 250, fontStyle: "italic" },
                { id: "grid-2-bg", type: "shape", shape: "rect", x: 540, y: 220, width: 400, height: 300, fill: "rgba(217,165,89,0.08)", radius: 8, stroke: "#d9a559", strokeWidth: 1, selectable: false },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 740, y: 230, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "art-2-name", type: "text", text: "MELINA", x: 540, y: 475, width: 400, fontSize: 22, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 250, fontStyle: "italic" },
                { id: "grid-3-bg", type: "shape", shape: "rect", x: 100, y: 550, width: 400, height: 300, fill: "rgba(217,165,89,0.08)", radius: 8, stroke: "#d9a559", strokeWidth: 1, selectable: false },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 300, y: 560, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "art-3-name", type: "text", text: "KEYSER", x: 100, y: 805, width: 400, fontSize: 22, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 250, fontStyle: "italic" },
                { id: "grid-4-bg", type: "shape", shape: "rect", x: 540, y: 550, width: 400, height: 300, fill: "rgba(217,165,89,0.08)", radius: 8, stroke: "#d9a559", strokeWidth: 1, selectable: false },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-baileAnamaria.png", x: 740, y: 560, scaleX: 0.55, scaleY: 0.55, originX: "center", originY: "top" },
                { id: "art-4-name", type: "text", text: "ROCÍO", x: 540, y: 805, width: 400, fontSize: 22, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", originX: "left", originY: "top", charSpacing: 250, fontStyle: "italic" },
                { id: "info-bg", type: "shape", shape: "rect", x: 0, y: 900, width: 1080, height: 445, fill: "rgba(5,5,5,0.9)", selectable: false },
                { id: "date", type: "text", text: "SÁB 14 · DOM 15 DE FEBRERO", x: 0, y: 945, width: 1080, fontSize: 30, fontFamily: "Playfair Display, serif", color: "#ffffff", textAlign: "center", charSpacing: 200, fontStyle: "italic" },
                { id: "hours", type: "text", text: "8 CLASES  ·  4 ESTILOS  ·  2 DÍAS", x: 0, y: 1010, width: 1080, fontSize: 18, fontFamily: "Anton, Impact, sans-serif", color: "#d9a559", textAlign: "center", charSpacing: 300 },
                { id: "venue", type: "text", text: "CAMELOT SALAMANCA  ·  PL. SAN JUSTO 1", x: 0, y: 1075, width: 1080, fontSize: 17, fontFamily: "Playfair Display, serif", color: "#ffffff", textAlign: "center", charSpacing: 220, fontStyle: "italic" },
                { id: "city", type: "text", text: "SALAMANCA", x: 0, y: 1115, width: 1080, fontSize: 26, fontFamily: "Anton, Impact, sans-serif", color: "#d9a559", textAlign: "center", charSpacing: 600 },
                { id: "price-bg", type: "shape", shape: "rect", x: 340, y: 1180, width: 400, height: 55, fill: "transparent", stroke: "#d9a559", strokeWidth: 2, radius: 27, selectable: false },
                { id: "price", type: "text", text: "PACK 2 DÍAS  ·  90€", x: 0, y: 1195, width: 1080, fontSize: 22, fontFamily: "Playfair Display, serif", color: "#d9a559", textAlign: "center", charSpacing: 300, fontStyle: "italic" },
                { id: "cta", type: "text", text: "STREETSALAMANCA.ES  ·  RESERVA ONLINE", x: 0, y: 1265, width: 1080, fontSize: 13, fontFamily: "Playfair Display, serif", color: "rgba(217,165,89,0.85)", textAlign: "center", charSpacing: 350, fontStyle: "italic" },
            ] },
        ],
    },
...
// ─── 81 — Reggaeton Battle 6 artistas (coral rojo/negro/blanco) ─────
    {
        ...
        variants: [
            { format: "portrait", width: 1080, height: 1350, layers: [
                ...
                { id: "art-1", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/04_malik_santos_perfil.png", x: 180, y: 170, scaleX: 0.42, scaleY: 0.42, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,1)", blur: 25, offsetX: 0, offsetY: 0 } },
                { id: "art-2", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/02_damian_reyes_perfil.png", x: 900, y: 170, scaleX: 0.42, scaleY: 0.42, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,1)", blur: 25, offsetX: 0, offsetY: 0 } },
                { id: "art-3", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/Profe-jean.png", x: 200, y: 460, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,1)", blur: 25, offsetX: 0, offsetY: 0 } },
                { id: "art-4", type: "image", src: "https://pub-9dafc090b0534d8fabaaf9ccc21936a0.r2.dev/models/Dance/03_nia_batista_perfil.png", x: 880, y: 460, scaleX: 0.5, scaleY: 0.5, originX: "center", originY: "top", shadow: { color: "rgba(255,255,255,1)", blur: 25, offsetX: 0, offsetY: 0 } },
