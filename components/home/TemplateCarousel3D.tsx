...
const CATS = ["Todas","Salsa","Bachata","Urbano","Festival","Concierto","Premium","1 artista","2 artistas"];

const TEMPLATES = [
    { id: 1, name: "BACHATA SENSUAL", date: "SÁB 25 MAY", venue: "Discoteca Elegance", img: "https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?q=80&w=600", accent: "#c084fc", tag: "BACHATA" },
    { id: 2, name: "URBANO NIGHT", date: "VIE 31 MAYO · 11PM", venue: "Club Kings · Madrid", img: "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?q=80&w=600", accent: "#a855f7", tag: "URBANO" },
    ...
    { id: 4, name: "SALSA LIVE", date: "VIE 24 MAYO · 11PM", venue: "Club Latino · Madrid", img: "https://images.unsplash.com/photo-1545959570-a94084071b5d?q=80&w=600", accent: "#facc15", tag: "SALSA" },
    ...
    { id: 6, name: "BACHATA DELUXE", date: "SÁB 08 JUNIO", venue: "Club Euphoria", img: "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?q=80&w=600", accent: "#c084fc", tag: "BACHATA" },
    { id: 7, name: "REGGAETÓN OLD SCHOOL", date: "SÁB 01 JUNIO", venue: "Arena Monterrey", img: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?q=80&w=600", accent: "#fb923c", tag: "URBANO" },
];
    ...
    return (
        <>
            ...
            <div className="flex gap-1.5 flex-wrap mb-3 px-2">
                {CATS.map((c, i) => (
                    <button key={c}
                        className={`text-xs px-3 py-1 rounded-full font-medium transition-all whitespace-nowrap ${i === 0 ? "text-white" : "bg-white/5 border border-white/10 text-gray-400 hover:text-white"}`}
            ...
            {/* Carousel */}
            <div className="relative w-full mx-auto" style={{ height: `${CARD_H + 20}px` }}>

                {/* Floor glow */}
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 pointer-events-none"
                    style={{ width: "1000px", height: "130px", background: "radial-gradient(ellipse at center, rgba(168,85,247,0.45) 0%, rgba(250,204,21,0.18) 40%, transparent 70%)", filter: "blur(22px)", opacity: 0.85 }} />

                {/* Nav buttons — vertically centered with cards */}
                <button className="swiper-btn-prev absolute left-0 z-20 flex items-center justify-center text-white text-2xl font-bold rounded-full transition-all hover:scale-110"
                    style={{ width: "50px", height: "50px", top: `${CARD_H / 2 - 25}px`, background: "rgba(124,58,237,0.85)", border: "1px solid rgba(196,132,252,0.5)", boxShadow: "0 0 25px rgba(168,85,247,0.55)" }}>
                    ‹
                </button>
                <button className="swiper-btn-next absolute right-0 z-20 flex items-center justify-center text-white text-2xl font-bold rounded-full transition-all hover:scale-110"
                    style={{ width: "50px", height: "50px", top: `${CARD_H / 2 - 25}px`, background: "rgba(124,58,237,0.85)", border: "1px solid rgba(196,132,252,0.5)", boxShadow: "0 0 25px rgba(168,85,247,0.55)" }}>
                    ›
                </button>
                ...
                <Swiper
                    ...
                    coverflowEffect={{ rotate: 20, stretch: 10, depth: 200, modifier: 1.4, slideShadows: false }}
                    style={{ width: "100%", height: `${CARD_H + 10}px`, overflow: "visible" }}
                >
                    {TEMPLATES.map(t => (
                        <SwiperSlide key={t.id} style={{ width: `${CARD_W}px`, height: `${CARD_H}px` }}>
                            {({ isActive }) => (
