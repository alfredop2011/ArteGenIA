...
const CARD_CONFIG: Record<number, {
    ...
    3: {
        photo: "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?q=80&w=600&h=750&fit=crop",
        gradient: "linear-gradient(to top, rgba(2,6,23,0.97) 40%, rgba(15,26,58,0.6) 70%, rgba(0,0,0,0.2) 100%)",
        titleColor: "#22d3ee",
        accentColor: "#ec4899",
        titleFont: "Bebas Neue",
    },
    4: {
        ...
        gradient: "linear-gradient(to top, rgba(17,24,39,0.97) 40%, rgba(31,41,55,0.6) 70%, rgba(0,0,0,0.3) 100%)",
        titleColor: "#facc15",
        accentColor: "#facc15",
        titleFont: "Bebas Neue",
    },
    5: {
        ...
        gradient: "linear-gradient(to top, rgba(26,5,0,0.97) 40%, rgba(45,8,0,0.6) 70%, rgba(0,0,0,0.2) 100%)",
        titleColor: "#fef2f2",
        accentColor: "#fb923c",
        titleFont: "Bebas Neue",
    },
    6: {
        ...
        gradient: "linear-gradient(to top, rgba(10,10,26,0.97) 40%, rgba(13,31,26,0.6) 70%, rgba(0,0,0,0.2) 100%)",
        titleColor: "#ffffff",
        accentColor: "#34d399",
        titleFont: "Bebas Neue",
    },
    7: {
        ...
        gradient: "linear-gradient(to top, rgba(13,0,5,0.97) 40%, rgba(26,0,16,0.6) 70%, rgba(0,0,0,0.2) 100%)",
        titleColor: "#fce7f3",
        accentColor: "#ec4899",
        titleFont: "Bebas Neue",
    },
    8: {
        ...
        gradient: "linear-gradient(to top, rgba(5,0,20,0.97) 40%, rgba(13,0,40,0.6) 70%, rgba(0,0,0,0.2) 100%)",
        titleColor: "#a855f7",
        accentColor: "#06b6d4",
        titleFont: "Bebas Neue",
    },
...
export default function TemplateCard({ template }: TemplateCardProps) {
    const config = CARD_CONFIG[template.id] ?? CARD_CONFIG[1];

    const textLayers = template.layers.filter(l => l.type === "text") as Extract<typeof template.layers[0], { type: "text" }>[];
    const titleLayer = textLayers.reduce((a, b) => (a.fontSize > b.fontSize ? a : b), textLayers[0]);
    ...
    const dateLayer = textLayers.filter(l => l.fontSize < 18 && (l.text.includes("JUNIO") || l.text.includes("JULIO") || l.text.includes("AGOSTO") || l.text.includes("JULIO") || l.text.toLowerCase().includes("jun") || l.text.toLowerCase().includes("jul"))).slice(0, 1)[0];
